...
type NavProps = {
  theme: string;
  onClickChangeTheme: (e: React.MouseEvent<HTMLInputElement>) => void;
};

const Nav = ({ theme, onClickChangeTheme }: NavProps): React.ReactElement => {
  return (
    <div className="navbar bg-base-100 shadow-md">
      <div className="flex-1">
        <img
          className="h-[56px] w-[100px]"
        ...
        <div className="dropdown dropdown-end">
          <label tabIndex={0} className="btn btn-ghost btn-circle avatar">
            <div className="w-10 rounded-full">
              <img src="https://avatars.githubusercontent.com/u/89175955?v=4" />
            </div>
          </label>
          <ul
            tabIndex={0}
